...
import { environments } from 'src/environments/environment'; // vincula a la BD con la APP
...
@NgModule({
  ...
  imports: [
    ...
    AngularFireModule.initializeApp(environments.firebaseConfig), // Inicializar Firebase dentro del proyecto
